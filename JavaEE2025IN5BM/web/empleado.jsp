...
<body>
    ...
    <div class="contenedor-principal">
        <div class="panel-formulario">
            ...
            <form action="" method= "input" class="formulario">
                <input type="text" autocomplete="off" name="txtCodigoEmpleado" class="input" placeholder="Codigo Empleado">
                <input type="text" autocomplete="off" name="txtNombreEmpleado" class="input" placeholder="Nombre Empleado">
                <input type="text" autocomplete="off" name="txtApellidoEmpleado" class="input" placeholder="Apellido">
                <input type="text" autocomplete="off" name="txtDireccion" class="input" placeholder="Dirección">
                <input type="text" autocomplete="off" name="txtTelefono" class="input" placeholder="Teléfono">
                <input type="text" autocomplete="off" name="txtCorreoElectronico" class="input" placeholder="Correo Electrónico">
                <input type="text" autocomplete="off" name="txtPuesto" class="input" placeholder="Puesto">
