    ...
    <div class="contenedor-principal">
        <div class="panel-formulario">
            ...
            <form action="Controlador?menu=Empleado" method= "POST" class="formulario">
                <input type="text" autocomplete="off" value= "${empleado.getCodigoEmpleado()}"name="txtCodigoEmpleado" class="input" placeholder="Codigo Empleado">
                <input type="text" autocomplete="off" value= "${empleado.getNombreEmpleado()}" name="txtNombreEmpleado" class="input" placeholder="Nombre Empleado">
                <input type="text" autocomplete="off" value= "${empleado.getApellidoEmpleado()}" name="txtApellidoEmpleado" class="input" placeholder="Apellido">
                <input type="text" autocomplete="off" value= "${empleado.getDireccionEmpleado()}" name="txtDireccion" class="input" placeholder="Dirección">
                <input type="text" autocomplete="off" value= "${empleado.getTelefonoEmpleado()}" name="txtTelefono" class="input" placeholder="Teléfono">
                <input type="text" autocomplete="off" value= "${empleado.getEmailEmpleado()}" name="txtCorreoElectronico" class="input" placeholder="Correo Electrónico">
                <input type="text" autocomplete="off" value= "${empleado.getPuestoEmpleado()}" name="txtPuesto" class="input" placeholder="Puesto">
                
            

                <div class="botones">
                    <button type="submit"name="accion" value="Agregar" class="btn-insertar" >
